...
/** @deprecated OneDrive is intentionally unsupported until a production driver is shipped. */
final class OneDriveDriver implements StorageDriverInterface
{
  ...
  {
    return new UnsupportedDriverException($operation, $this->name(), 'The OneDrive driver is not implemented.');
  }
}
